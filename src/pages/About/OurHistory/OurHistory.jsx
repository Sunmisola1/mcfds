import 'animate.css'; // Import Animate.css for animations
 import headmistressImage from '../../../assets/img/6.jpg';
 import ourschool from '../../../assets/img/backgroud.jpg';
import 'animate.css'; // Import animate.css for animations
...
const OurHistory = () => {
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      {/* Hero Section */}
      <div className="banner text-white py-20 text-center">
      ...
      <div className="container  mx-auto  px-10 py-12">
        ...
        <div className="flex flex-col md:flex-row space-y-8 md:space-y-0 ">
          ...
          <div className="md:w-1/2">
            ...
            <p className="text-gray-700 animate__animated animate__fadeInRight">
              ...
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. 
              Nullam eu libero ac orci ultricies consectetur ut ut quam. 
              Etiam commodo justo ac ligula vestibulum, at mattis justo commodo.   Lorem ipsum dolor sit amet, consectetur adipiscing elit. 
              Nullam eu libero ac orci ultricies consectetur ut ut quam. 
              Etiam commodo justo ac ligula vestibulum, at mattis justo commodo.
            </p>
          </div>
          <div className="md:w-1/2 flex justify-center">
            <img src={headmistressImage} alt="Headmistress" className="rounded-lg shadow-md w-72  h-72 animate__animated animate__fadeInLeft" />
          </div>
        </div>
        ...
        <div className=" mx-auto py-10 px-4  mt-9 md:px-0">
        <div className="flex flex-col md:flex-row items-center justify-center mb-10">
          {/* Vision */}
          <div className="md:w-1/2 px-4 py-10 mr-2 mb-6 md:mb-0 animate__animated animate__fadeInLeft shadow-lg shadow-blue-900">
          ...
          {/* Mission */}
          <div className="md:w-1/2 px-4 py-7 animate__animated animate__fadeInRight shadow-lg shadow-blue-900">
 ...
 <div className="container mx-auto py-12 px-4 md:px-0">
        <div className="flex flex-col md:flex-row  justify-center">
            ...
            <img src={ourschool} alt="School Journey" className="rounded-lg shadow-lg mb-4" />
          </div>
          {/* Text */}
